// template-editor.js - редактирование шаблона и визуализация плейсхолдеров.
...
export function initTemplateEditor() {
  ...
  placeholderHint.textContent = "Получатели: все сохранённые контакты в базе данных.";
