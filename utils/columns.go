...
=======
//
// Фиксированные поля контакта распознаются по русским и английским вариантам.
// Все остальные заголовки считаются произвольными данными (ColumnGeneric).
>>>>>>> 857fd01c67dd7bf371b09cfa9f01972acfde90c0
package utils
